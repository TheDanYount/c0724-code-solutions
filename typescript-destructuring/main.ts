...
const { title: theTitle, author: theAuthor, libraryId: theLibraryId } = book2;
console.log(
  `The title of the book is ${theTitle}, the author is ${theAuthor}, and the library id is ${theLibraryId}`
);
