...
function renderPokemon(pokemon) {
  const $col1of3 = document.createElement('div');
  $col1of3.setAttribute('class', 'column-third');
  const $pokemonCard = document.createElement('div');
  $pokemonCard.setAttribute('class', 'pokemon-card');
  $col1of3.append($pokemonCard);
...
for (const pokemon of pokedex) {
  const HTMLformattedPokemon = renderPokemon(pokemon);
  $row.append(HTMLformattedPokemon);
}
